...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
      ...
      <title>Larabreeds | @yield('title', 'Home')</title>
  ...
  <body class="antialiased">
    <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <span class="navbar-brand mb-0 h1">Larabreeds</span>
    ...
    @yield('content')
    <footer class="bg-light text-center pt-3 main-footer">
      <div class="container">
        <div class="row">
          <div class="col">
            <p>Made with <i class="bi bi-heart-fill"></i> by
               <a href="https://github.com/AleejandroReyna" target="_blank">Alejandro Reyna</a></p>
          </div>
        </div>
      </div>
    </footer>
